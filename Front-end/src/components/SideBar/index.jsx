...
const SideBar = () => {
  ...
  return (
    <aside data-testid="Sidebar" className="h-screen w-20 flex flex-col text-zinc-300 group hover:transition-all hover:w-2/12">
      <div className="flex w-full flex-col h-full relative bg-slate-800 py-6">
        <nav className="space-y-8 text-lg">
          <div className="justify-center text-center flex flex-col items-center">
            <img src={user.avatarUrl} alt="Imagem de Perfil" className="border-4 rounded-full w-8 border-sky-900" />
            <span className="font-semibold pt-2 text-md">{user.name}</span>
          </div>
