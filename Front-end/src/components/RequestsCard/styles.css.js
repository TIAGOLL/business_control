const requestCard = {
  ...
  headTable: 'items-center justify-center bg-slate-800 w-full mt-10 h-8 text-zinc-100 font-semibold flex flex-row',

  tableLines: 'items-center justify-center bg-slate-600 w-full text-md h-8 text-zinc-100 flex flex-row hover:bg-slate-500',
